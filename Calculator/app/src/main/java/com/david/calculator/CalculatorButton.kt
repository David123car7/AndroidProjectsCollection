...
import com.david.calculator.ui.theme.WhiteGray
import com.david.calculator.ui.theme.Gray
...
fun CalculatorButton(modifier: Modifier = Modifier, onButtonPressed: (String) -> Unit, isOperation: Boolean, label: String){
    Button(onClick = {onButtonPressed(label)},
        ...
        colors = ButtonDefaults.buttonColors(if(isOperation) Gray else WhiteGray)){
        Text(label,
